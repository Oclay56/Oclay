...
app = FastAPI(
    title="OCLAY Data API",
    version="0.2.0",
    description=(
        "Simple AI-led data layer for Custom GPT Actions. GPT decides; this backend "
        "normalizes Stake odds, MLB Stats API context, validation, and review-slip building."
    ),
)
...
async def root() -> dict[str, str]:
    return {"service": "oclay-data-api", "status": "ok"}
...
async def gpt_privacy_policy() -> dict[str, Any]:
    return {
        "name": "OCLAY Action Privacy Policy",
        "summary": (
