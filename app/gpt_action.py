...
def build_gpt_action_openapi_schema(server_url: str) -> dict[str, Any]:
    ...
    schema: dict[str, Any] = {
        ...
        "info": {
            ...
            "version": "0.2.0",
            "description": (
                "Structured data API for OCLAY. The GPT owns final betting "
                "decisions; this backend only provides Stake availability, MLB "
                "context, validation, and review-slip building."
            ),
        },
        ...
        "paths": {
            ...
            "/mlb/stake-ui/remove-sidebar-group": {
                "post": _operation(
                    ...
                    (
                        "Removes one visible review-slip SGM game group by "
                        "fixture/matchup. "
...
async def build_comparison_board(
    ...
    return {
        ...
        **pagination["meta"],
        ...
        "notes": [
            "Rows are compact helper metrics, not Oclay picks.",
