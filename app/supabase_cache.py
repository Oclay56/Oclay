...
def cleanup_operations(
    *,
    ...
    expired_payload = {
        "status": "expired",
        "error_message": "Expired by OCLAY Supabase cache cleanup.",
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Clean old OCLAY local UI bridge rows from Supabase and rebuildable local cache files.",
    )
    ...
    if result is not None:
        ...
        print("Kept: pending fresh jobs and current market mappings.")
        print()
